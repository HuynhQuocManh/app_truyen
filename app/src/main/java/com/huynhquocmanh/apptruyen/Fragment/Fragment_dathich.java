...
public class Fragment_dathich extends Fragment {
    View view;
    RecyclerView recyclerView;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_dathich,container,false);
        recyclerView =view.findViewById(R.id.recyclerviewdathich);
        Getdata();
        return view;
    }
